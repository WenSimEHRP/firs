...
industry.add_industry_jetty_layout(
    ...
    layout=[
        ...
        (0, 1, "wharf_spritelayout_silo_1_auto_orient"),
        (0, 2, "wharf_spritelayout_silo_2_auto_orient"),
        (0, 3, "wharf_spritelayout_shed_1_auto_orient"),
        (0, 4, "wharf_spritelayout_tanks_1_auto_orient"),
        (0, 5, "wharf_spritelayout_tanks_2_auto_orient"),
        ...
        (1, 3, "wharf_spritelayout_warehouse_full_auto_orient"),
        (1, 4, "wharf_spritelayout_crane_orthogonal_auto_orient"),
        (1, 5, "wharf_spritelayout_water_ship_1_auto_orient"),
        (1, 6, "spritelayout_null_water"),
        # ensure spacing from coast, to improve map-gen buildabilty
        (2, 2, "wharf_spritelayout_warehouse_half_auto_orient"),
        (2, 3, "wharf_spritelayout_warehouse_half_auto_orient"),
        (2, 4, "wharf_spritelayout_crane_rails_orthogonal_auto_orient"),
...
industry.add_industry_jetty_layout(
    ...
    layout=[
        ...
        (3, 4, "wharf_spritelayout_silo_1_auto_orient"),
        (3, 5, "wharf_spritelayout_silo_2_auto_orient"),
        (3, 6, "wharf_spritelayout_shed_1_auto_orient"),
        (3, 7, "spritelayout_null_water"),
        # additional spacing at end of jetty (for better clearance in map edge context), only one tile needed for this
        (3, 8, "spritelayout_null_water"),
    ],
